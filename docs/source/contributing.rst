...
The `GitHub issue
tracker <https://github.com/samirelanduk/kirjava/issues>`__ is the place
...
The first step is to fork the kirjava repository to your own GitHub
...
clone your new copy of kirjava to your local machine, and to do this
you simply enter ``clone https://github.com/YOUR_USERNAME/kirjava`` at
...
An ideal pull request for kirjava is one that either adds a function (or
...
If your pull request modifies large parts of kirjava, changes the way the
...
If a function doesn't have tests, the function doesn't work. kirjava has
